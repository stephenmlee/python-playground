...
class CentralCorridor(Scene):
    def enter(self):
        ...
        print "put it in the bridge, and blow the ship up after hetting into an"
        print "escape pod."
        print "\n"
        print "You're running down the central corridor to the Weapons Armoury when"
        print "a Gothon jumps out, red scaly skin, dark grimy teeth, and evil clown costume"
        print "flowing around his hate filled body. He's blocking the door to the armoury"
        ...
        if action == "shoot!":
            ...
            print "off your aim. Your laser hits his costume but missed him entirely."
            ...
            print "Lbhe zbgure vf fb sng, jura fur fvgh nebhaq ubhfr, fur fvgf nebhaq gur ubhfr."
...
class LaserWeaponArmoury(Scene):
    def enter(self):
        ...
        print "wrong 10 times then the lock closes forever and you can't get the bomb."
        print "The code is 3 digits."
        code = "%d%d%d" % (randint(1, 9), randint(1, 9), randint(1, 9))
        guess = raw_input("[keypad]> ")
        guesses = 0
        while guess != "123" and guess != code and guesses < 9:
            print "BZZZZZZZEDDD!"
            guesses += 1
            guess = raw_input("[keypad]> ")
        if guess == code or guess == "123":
            print "The container clicks open and the seal breaks, letting gas out."
            print "You grab the neutron bomb and run as past as you can to the"
            ...
            print "from their ship and you die."
            return "death"
...
class TheBridge(Scene):
    def enter(self):
        ...
        print "to take control of the ship. Each of them has an even uglier"
        ...
        if action == "throw the bomb":
            print "In a panic you throw the bomb at the group of Gorthons"
